function line_Xindiantu_0102(x0,y0,x1,y1,a,u,xshape,Spd,k,alp,iscolor,OK)   //心电图动态
{
	if(iscolor)
	{
		r1 = map(sin(frameCount*15/200.0),-1,1,100,255); // 随机红色分量
        g = map(sin(frameCount*15/300.0),-1,1,0,255);   // 随机绿色分量
        b = map(sin(frameCount*15/400.0),-1,1,100,255); //随机蓝色分量
...
function line_Ajimide2_0102(x0,y0,x1,y1,u,T0,Spd,cm,alp,iscolor)  //阿基米德螺旋线动态线
{
	//clear();
	if(iscolor)
	{
